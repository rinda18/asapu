...
with open('user.json', 'r') as fp:
    wait = json.load(fp)
ditdit = LineClient(authToken='EsQ13QGOtg7NdxtoEUC5.hDOgkim5hPYhnGQ5BnuIHq.YI1I8IlEr8bONf/mnwHA6NQfiSrH1W8++L8AEX8G9p4=')
...
def headers():
    ...
    'X-Line-Application': "DESKTOPMAC\t5.5.1\tDzinBots\tTools\10.13.2",
    "x-lal": "ja-US_US",
    }
    return Headers
def waktu(secs):
